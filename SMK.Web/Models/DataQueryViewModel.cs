...
namespace SMK.Web.Models
{
    ...
    public class MedicineReportViewModel
    {
        ...
        /// 醫院資料
        /// </summary>
        public IniOpDtl IniOpDtl { get; set; }
        /// <summary>
        /// 醫院資料
        /// </summary>
        public List<IniOpOrdView> IniOpOrds { get; set; }      
        
        /// <summary>
        /// 藥局資料
        /// </summary>
        public IniDrDtl IniDrDtl { get; set; }
        /// <summary>
        /// 藥局資料
        /// </summary>
        public List<IniDrOrdView> IniDrOrds { get; set; }      
        /// <summary>
        /// 確認是藥局還是醫療院所
        /// </summary>
        public string CheckOpOrDr{ get; set; }
    }

    public class IniOpOrdView : IniOpOrd 
    { 
    ...
    public class IniDrOrdView : IniDrOrd
    { 
        public string OrderChiName { get; set; }
