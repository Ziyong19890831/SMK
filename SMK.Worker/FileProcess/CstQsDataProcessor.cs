...
{
    [TransientService]
    public class CstQsDataProcessor : FileInProcessor<MhbtQsData>, IIniFileInCtrlWriter
    {
        ...
        public string TableName { get; set; } = "MhbtQsData";
        public CstQsDataProcessor(SMKWEBContext context,
            ...
            NhiScheduleService nhiScheduleService)
        {
            ...
            PostProcess = x =>
            {
                ...
                try
                {
                    ...
                    // '更新初診日
                    context.Database.ExecuteSqlRaw("exec UpdateMhbtQsData");
                    txn.Commit();
            ...
            FileInHandler = new CstQsDataHandler();
        }
