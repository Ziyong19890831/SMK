...
{
    [TransientService]
    public class CstAgentPatientProcessor : FileInProcessor<MhbtAgentPatient>, IIniFileInCtrlWriter
    {
        ...
        public string TableName { get; set; } = "MhbtAgentPatient";
        public CstAgentPatientProcessor(SMKWEBContext context,
            ...
            NhiScheduleService nhiScheduleService)
        {
            ...
            FileInHandler = new CstAgentPatientHandler();
        }
