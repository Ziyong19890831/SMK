...
namespace SMK.Data.Entity
{
    ...
    /// 藥局門診處方及治療明細資料-原始檔
    /// </summary>
    [Index(nameof(TranDate))]
    public partial class IniDrDtl : IEquatable<IniDrDtl>
    {
        /// <summary>
        /// 電腦序號
        /// </summary>
        ...
        public bool Equals(IniDrDtl other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
            return DataId == other.DataId && FeeYm == other.FeeYm;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((IniDrDtl) obj);
        }

        public override int GetHashCode()
        {
            return HashCode.Combine(DataId, FeeYm);
        }
    }
}
