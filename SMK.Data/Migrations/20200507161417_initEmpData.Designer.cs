...
namespace SMK.Data.Migrations
{
    ...
    [Migration("20200507161417_initEmpData")]
    partial class initEmpData
    {
            ...
            modelBuilder.Entity("SMK.Data.Entity.GenEmpData", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Account = "Admin",
                            CreatedAt = new DateTime(2020, 5, 8, 0, 14, 17, 676, DateTimeKind.Local).AddTicks(3004),
                            Enable = true,
            ...
            modelBuilder.Entity("SMK.Data.Entity.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "00000000-0000-0000-0000-000000000000",
                            CreatedAt = new DateTime(2020, 5, 8, 0, 14, 17, 678, DateTimeKind.Local).AddTicks(1398),
                            Name = "SuperAdmin"
                        });
                });
            ...
            modelBuilder.Entity("SMK.Data.Entity.RoleEmpMapping", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "00000000-0000-0000-0000-000000000000",
                            CreatedAt = new DateTime(2020, 5, 8, 0, 14, 17, 678, DateTimeKind.Local).AddTicks(2888),
