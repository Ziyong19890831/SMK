...
namespace SMK.Data.Migrations
{
    ...
    [Migration("20200529174140_fixIsUnicode_IsFixedLength")]
    partial class fixIsUnicode_IsFixedLength
    {
            ...
            modelBuilder.Entity("SMK.Data.Entity.GenEmpData", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Account = "Admin",
                            CreatedAt = new DateTime(2020, 5, 30, 1, 41, 40, 501, DateTimeKind.Local).AddTicks(2920),
                            Enable = true,
            ...
            modelBuilder.Entity("SMK.Data.Entity.HospContract", b =>
                {
                    ...
                    b.HasIndex("HospId", "HospSeqNo", "SmkcontractType", "HospStartDate")
                        .IsUnique()
                        .HasFilter("[HospID] IS NOT NULL AND [HospSeqNo] IS NOT NULL AND [SMKContractType] IS NOT NULL AND [HospStartDate] IS NOT NULL");
            ...
            modelBuilder.Entity("SMK.Data.Entity.PrsnLicence", b =>
                {
                    ...
                    b.Property<string>("LicenceEndDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(8)")
                        .HasDefaultValueSql("('')")
                        .HasMaxLength(8);
            ...
            modelBuilder.Entity("SMK.Data.Entity.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "00000000-0000-0000-0000-000000000000",
                            CreatedAt = new DateTime(2020, 5, 30, 1, 41, 40, 503, DateTimeKind.Local).AddTicks(2247),
                            Name = "SuperAdmin"
                        });
                });
            ...
            modelBuilder.Entity("SMK.Data.Entity.RoleEmpMapping", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "00000000-0000-0000-0000-000000000000",
                            CreatedAt = new DateTime(2020, 5, 30, 1, 41, 40, 503, DateTimeKind.Local).AddTicks(3837),
